package com.papaolabs.api.infrastructure.persistence.restapi.account;
...
public interface AccountApiClient {
    ...
    AccountKitProfileResponse validateAccessToken(@Param("access_token") String accessToken, @Param("appsecret_proof") String appSecretRoot);
    ...
    @RequestLine("DELETE /{account_id}?access_token={access_token}")
